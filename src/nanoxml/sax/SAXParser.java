   ...
   implements Parser
{
    ...
    */
   private void handleSubTree(kXMLElement element,
                              SAXLocator locator)
      throws SAXException
   {
      AttributeListImpl attrList = new AttributeListImpl();
      locator.setLineNr(element.getLineNr());
      Enumeration enum_ = element.enumeratePropertyNames();
      ...
      if (element.getContents() == null)
         {
            enum_ = element.enumerateChildren();
            
            while (enum_.hasMoreElements())
               {
                  this.handleSubTree((kXMLElement)(enum_.nextElement()),
                                     locator);
               }
         }
      else
   ...
   public void parse(InputSource source)
      throws SAXException,
             IOException
   {
      kXMLElement topElement = new kXMLElement();
